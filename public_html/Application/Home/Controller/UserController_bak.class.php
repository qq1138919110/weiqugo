            ...
            //file_put_contents("test1.txt",json_encode($_COOKIE));
              if(trim(I('post.user_phone'))!="" and trim(I('post.user_code'))!=""){
                ...
                if(!$verify_info){
                  ...
                  if($verify_info['status']==1 or intval($verify_info['add_time']-time()) > 9000){
          ...
          if(IS_POST){
            ...
            if($re){
              ...
              if(i('get.page')=='submit_cart'){
                header('Location:index.php?s=/Home/Order/submit_cart&id='.i('get.cart_id'));exit;
          ...
          if(!isset($_COOKIE['login_user_id'])){
            ...
            if($user_info){
              if($user_info['openid']==""){
                ...
                $appsecret="f44897ebbfb7349358aa7b307aa021f3";
