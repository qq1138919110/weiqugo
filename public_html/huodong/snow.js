...
THREE.CanvasRenderer = function(a) {
    ...
    this.render = function(a, j) {
        function i(a) {
            ...
            e = d.color,
            d instanceof THREE.AmbientLight ? ($T.r += e.r, $T.g += e.g, $T.b += e.b) : d instanceof THREE.DirectionalLight ? (ta.r += e.r, ta.g += e.g, ta.b += e.b) : d instanceof THREE.PointLight && (ua.r += e.r, ua.g += e.g, ua.b += e.b)
        }
        function n(a, b, c, d) {
            var e, f, g, h, k, j;
            e = 0;
...
$(function() {
    ...
    particleImage.src = "http://resnap.weiuxiu.cn/bzxc/icon/snowMin.png";
    var snowNum = 100;
    function init() {
